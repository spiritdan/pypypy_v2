...
for y in words_knows:
    # 启动一个循环，循环的次数等于用户认识的单词数量。

    # print('\n\n'+str(y['definition_choices'][0]['rank'])+y['definition_choices'][0]['definition'])
    # \n\n是两个换行，比照json文件，你会发现str(y['definition_choices'][0]['rank'])是第0个翻译的rank值，后面是第0个翻译的内容。
